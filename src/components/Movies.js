  ...
  return (
    <Container>
      ...
      <Content>
        <Wrap>
          <Link to="/detail">
            <img alt="" src="https://blog.kakaocdn.net/dn/bSnAxt/btqDGgD3wMx/s9ExsDd33hqHm0TNh27gb0/img.jpg" />
          </Link>
        </Wrap>
        <Wrap>
          <Link to="/detail">
